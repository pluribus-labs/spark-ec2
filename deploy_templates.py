...
template_vars = {
  ...
  "spark_worker_opts": os.getenv("SPARK_WORKER_OPTS", "-Dspark.worker.cleanup.enabled=true -Dspark.worker.cleanup.interval=1800 -Dspark.worker.cleanup.appDataTtl=1200"),
